	...
	return (
		<MotionConfig reducedMotion='user'>
			<motion.div
				...
				initial='hide'
				animate='show'
				className={`App pb-20  min-h-screen text-[#494C6B] dark:text-[#C8CBE7] ${isDarkMode ? 'dark' : 'light'}`}
			>
				<div className='max-w-lg m-auto px-6 pt-3 sm:pt-20 '>
					<header className='flex mb-5 items-center'>
						...
						<motion.div variants={item} className='text-4xl font-bold  pt-3  text-accent dark:text-white transition-colors duration-500'>
